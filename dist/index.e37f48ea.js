...
var _queriesJs = require("./queries.js");
...
/**
 * Asynchronously controls the process of fetching and displaying a recipe based on the ID from the URL hash.
 * It first attempts to retrieve the recipe ID from the window's location hash. If an ID is present,
 * it proceeds to render a loading spinner, update the active recipe in both the results and bookmarks previews,
 * fetch the recipe data using the model's loadRecipe method, and finally render the fetched recipe.
 * If any part of this process fails, such as if the recipe cannot be loaded, it renders an error message.
 */ const controlRecipe = async function() {
    try {
        ...
        (0, _resultsViewJsDefault.default).update(_modelJs.getSearchResultsPage(_modelJs.state.search.currentPage));
...
const controlServing = function(numServings) {
    ...
    _modelJs.updateServings(numServings);
...
const controlRenderBookmarks = ()=>(0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
// Adding a new ingredient input field
const controlAddIng = ()=>(0, _addRecipeViewJsDefault.default).addIngredient();
// Removing an ingredient input field
const controlRemoveIng = (label, inputFields)=>(0, _addRecipeViewJsDefault.default).removeIngredient(label, inputFields);
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        setTimeout(()=>(0, _addRecipeViewJsDefault.default).killWindow(), (0, _configsJs.MODAL_CLOSE_SEC) * 1000);
    } catch (err) {
 ...
 */ const controlDelete = async function() {
    try {
        await _modelJs.deleteRecipe();
        (0, _recipeViewJsDefault.default).renderSuccessMessage("Your recipe was successfully deleted.");
        ...
        if (_modelJs.state.search.query && _modelJs.state.recipe.index !== -1) {
            // If it was last recipe on the page, render previous page
            const page = _modelJs.state.search.currentPage > Math.ceil(_modelJs.state.search.results.length / _modelJs.state.search.resultsPerPage) ? _modelJs.state.search.currentPage - 1 : _modelJs.state.search.currentPage;
...
const init = function() {
    (0, _bookmarksViewJsDefault.default).addHandlerRenderBookmarks(controlRenderBookmarks);
    ...
    (0, _recipeViewJsDefault.default).addHandlerDelete(controlDelete);
    (0, _searchViewJsDefault.default).addHandlerSearch(controlSearchResults);
    (0, _paginationViewJsDefault.default).addHandlerPagination(controlPagination);
    (0, _addRecipeViewJsDefault.default).addHandlerAddIng(controlAddIng);
    (0, _addRecipeViewJsDefault.default).addHandlerRemoveIng(controlRemoveIng);
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","core-js/modules/esnext.map.group-by.js":"3AR1K","core-js/modules/esnext.symbol.dispose.js":"b9ez5","regenerator-runtime":"dXNgZ","./queries.js":"383yS","./configs.js":"32SZE","./Views/recipeView.js":"17Msr","./Views/resultsView.js":"2WfRw","./Views/searchView.js":"1ldzZ","./Views/paginationView.js":"4oefe","./Views/bookmarksView.js":"hXwQt","./Views/addRecipeView.js":"4LvUr"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const state = {
    ...
    search: {
        ...
        results: [],
        currentPage: 1,
        resultsPerPage: (0, _configsJs.RES_PER_PAGE)
    },
    bookmarks: []
};
...
const loadRecipe = async function(id) {
    try {
        ...
        const data = await (0, _helpersJs.AJAX)(`${(0, _configsJs.API_URL)}${id}?key=${(0, _configsJs.KEY)}`);
...
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await (0, _helpersJs.AJAX)(`${(0, _configsJs.API_URL)}?search=${query}&key=${(0, _configsJs.KEY)}`);
...
const updateServings = function(numServings) {
    state.recipe.ingredients.forEach((ing)=>ing.quantity ? ing.quantity = ing.quantity * numServings / state.recipe.servings : "");
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const RawIngs = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("ingredient"));
        ...
        const data = await (0, _helpersJs.AJAX)(`${(0, _configsJs.API_URL)}?key=${(0, _configsJs.KEY)}`, recipe);
...
const deleteRecipe = async function() {
    try {
        ...
        const index = state.search.results.findIndex((rec)=>rec.id === state.recipe.id);
        // Saving the index to the recipe
        state.recipe.index = index;
        // Sending delete request to the API
        await (0, _helpersJs.deleteJSON)(`${(0, _configsJs.API_URL)}${state.recipe.id}?key=${(0, _configsJs.KEY)}`);
...
},{"regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./helpers.js":"hGI1E","./configs.js":"32SZE"}],"dXNgZ":[function(require,module,exports) {
/**
...
const AJAX = async function(url, uploadData) {
    try {
        ...
        const res = await Promise.race([
            fetchPro,
            timeout((0, _configsJs.TIME_OUT_SEC))
        ]);
...
},{"regenerator-runtime":"dXNgZ","./configs.js":"32SZE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"32SZE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY = "a2ee091e-b1c3-4654-842c-964184400f38";
const TIME_OUT_SEC = 10;
const RES_PER_PAGE = 10;
const MODAL_CLOSE_SEC = 2.5;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3AR1K":[function(require,module,exports) {
"use strict";
...
},{"6567f4dade5d8960":"dIGt4","f35d7393646ad055":"7GlkT","c4503f7eb1018306":"gOMir","d7c6ba4f404b5360":"fOR0B","ff883ec9010d6328":"4OXGm","f9f796f22480c881":"f9Wim","dc5cfe657d3f962b":"5ZsyC"}],"4OXGm":[function(require,module,exports) {
"use strict";
...
},{"2e34ececd06658d9":"gTwyA"}],"383yS":[function(require,module,exports) {
...
document.addEventListener("click", (e)=>{
    ...
    if (e.target.closest(".search") || e.target.closest(".search-results") || e.target.closest(".btn__mobile-search") || e.target.closest(".btn--inline")) return;
...
},{}],"2WfRw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
...
class ResultsView extends (0, _viewJs.View) {
    ...
    _generateMarkup() {
        return this._data.map((result)=>(0, _previewViewJsDefault.default)._generateMarkup(result)).join("");
    }
}
exports.default = new ResultsView();

},{"./View.js":"3BOfc","./previewView.js":"jn7RE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jn7RE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _iconsSvg = require("url:../../img/icons.svg");
...
},{"./View.js":"3BOfc","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1ldzZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
...
class PaginationView extends (0, _viewJs.View) {
    ...
    /**
   * Adds an event listener to the pagination parent element to handle click events.
   * When a pagination button is clicked, it retrieves the page number from the button's data attribute
   * and calls the provided handler function with the page number as its argument.
   *
   * @param {Function} handler - The function to be called when a pagination button is clicked.
   *                              It should accept a single argument: the page number to go to.
   */ addHandlerPagination(handler) {
    ...
    _generateMarkup() {
        ...
        if (this._data.currentPage === 1) return this._markupNext() + this._pageCount();
        // More than 1 page, it's the last page
        if (this._data.currentPage === this._data.numPages) return this._markupPrev() + this._pageCount();
        // On middle page
...
},{"./View.js":"3BOfc","./previewView.js":"jn7RE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4LvUr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _iconsSvg = require("url:../../img/icons.svg");
...
class AddRecipeView extends (0, _viewJs.View) {
    ...
    /**
   * Adds an event listener for the 'submit' event on the parent element, which is the form element.
   * When the form is submitted, it will call the provided handler function with the form data.
   ...
   */ addHandlerUpload(handler) {
    ...
    toggleWindow() {
        // Check if the form is already rendered, if not, render it by inserting the form's HTML markup
        if (!this._formRender) this._parentEl.insertAdjacentHTML("afterbegin", this._generateMarkup());
        this._formRender = true;
        // Make the window and overlay visible by removing the 'hidden' class
    ...
    addIngredient() {
        ...
        this._parentEl.querySelector(".ingredients").insertAdjacentHTML("beforeend", markup);
        this._numIngs++;
    }
...
},{"./View.js":"3BOfc","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hycaY","aenu9"], "aenu9", "parcelRequiref6b3")
